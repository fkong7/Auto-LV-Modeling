...
view = 1
data_folder_out = '/global/scratch/fanwei_kong/ImageData/MMWHS_small/2d_multiclass-coronal'
save_model_path = '/global/scratch/fanwei_kong/2DUNet/Logs/weights_multi-all-coronal_small.hdf5'
overwrite = False
